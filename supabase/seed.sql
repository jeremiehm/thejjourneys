...
values (
  ...
  'published',
  '[{"id":"seed-layout-hero","type":"hero","data":{"title":"Northern Vietnam","subtitle":"An itinerary through Hanoi, Ninh Binh, Ha Long, and Sapa.","imageUrl":"https://images.unsplash.com/photo-1528127269322-539801943592?auto=format&fit=crop&w=1600&q=80","align":"center"}},{"id":"seed-layout-grid","type":"article_grid","data":{"title":"The stops","columns":3}}]'::jsonb
)
...
select c.id, a.id, '48 hours in Hanoi', '48-hours-in-hanoi', 'First impressions in the old quarter.', 'https://images.unsplash.com/photo-1509030450996-dd1a26dda07a?auto=format&fit=crop&w=1600&q=80', 'published', now(), 1,
...
where c.slug = 'northern-vietnam' and a.slug = 'jeremie'
